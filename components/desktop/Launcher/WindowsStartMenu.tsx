    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          <div className="relative px-7 pt-7">
            <div className="relative">
              ...
              <Input
                ...
                className="h-10 rounded-full border-white/10 bg-white/[0.04] pl-10 text-sm placeholder:text-neutral-500 focus-visible:ring-sky-500/40"
              />
            </div>
          </div>

          <div className="relative px-7 pb-3 pt-5">
            ...
            <div className="mt-3 grid grid-cols-6 gap-1">
              {filteredPinned.map((app) => (
                <button
                  ...
                  className="group flex flex-col items-center gap-1.5 rounded-md px-2 py-3 transition-colors hover:bg-white/5"
                >
          ...
          <div className="relative flex items-center justify-between border-t border-white/10 bg-white/[0.02] px-7 py-3">
